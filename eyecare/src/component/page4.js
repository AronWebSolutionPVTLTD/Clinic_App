...
function Page4() {
  ...
  localStorage.setItem("Visit_timer", formatTime(timer));
  const Patient_timer = localStorage.getItem("Patient_timer");
  let Technician_timer = localStorage.getItem("Technician_timer");
  return (
    <>
      <meta charSet="UTF-8" />
            ...
            <div className="col-md-8 doctors_row">
              <div className="priority_sec">
                <div className="priority_header">
                  <div className="priority_time priority_time_2">
                    <h4>Visit Timer</h4>
                ...
                <div className="priority_row">
                  <div className="priority_col_lg">
                    ...
                    <div className="cmn_btn_wrapper">
                      <button className="cmn_btn" onClick={handle_end}>
                        <img src="images/check-icon.png" /> End Visit
                      </button>
                    </div>
                  </div>
                  <div className="priority_col_sm">
                    <div className="tech_time">
                      ...
                      <div className="time_icon_text">
                        <img src="images/clock.png" className="clock_icon" />
                        <p>{Technician_timer}</p>
                      </div>
                    </div>
                    <div className="tech_time">
                      <p className="tech_tm_hd">Patient Waiting </p>
                      <div className="time_icon_text">
                        <img src="images/clock.png" className="clock_icon" />
                        <p>{Patient_timer}</p>
                      </div>
